...
public class playerPrefsMANAGER : MonoBehaviour
{
    ...
    [SerializeField]
    private Button btn_loc,btn_insID,btn_img1,btn_img2,btn_img3,btn_img4,btn_img5,btn_img6,btn_back,btn_continue;
    //[SerializeField]
...
public static List<string> Defects_list=new List<string>{}; 
    ...
    void Update()
    {
        if (Language_Manager.lang == 0) btn_text_handler();
        else btn_text_handlerFR();
    }
    ...
    void btn_text_handler(){
        ...
        btn_continue.GetComponentInChildren<Text>().text = "Save and\nContinue\n>";

        btn_back.GetComponentInChildren<Text>().text = "Back and\nDelete\n<";
        }
        catch{}
    ...
    void btn_text_handlerFR(){
        try{ 
        btn_loc.GetComponentInChildren<Text>().text  = "lieu:" + ins_list["Location"];
        
        btn_insID.GetComponentInChildren<Text>().text  = "id de inspection:" + ins_list["ID"] ;
        ...
        btn_continue.GetComponentInChildren<Text>().text = "Sauver et\nContinuer\n>";

        btn_back.GetComponentInChildren<Text>().text = "Retour et\nEffaser\n<";
        }
        catch{}
